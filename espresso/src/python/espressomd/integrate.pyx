...
cdef class Integrator:
    ...
    def run(self, steps=1, recalc_forces=False, reuse_forces=False, i_know_what_im_doing=False):
        """
        Run the integrator.
        ...
        if self._method == "VV" or self._method == "NVT" or self._method == "NPT":
            ...
            _integrate(steps, recalc_forces, reuse_forces, i_know_what_im_doing)
