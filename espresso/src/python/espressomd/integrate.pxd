...
cdef extern from "integrate.hpp" nogil:
    cdef int python_integrate(int n_steps, cbool recalc_forces, int reuse_forces, cbool i_know_what_im_doing)
...
cdef inline int _integrate(int nSteps, cbool recalc_forces, int reuse_forces, cbool i_know_what_im_doing):
    with nogil:
        return python_integrate(nSteps, recalc_forces, reuse_forces, i_know_what_im_doing)
